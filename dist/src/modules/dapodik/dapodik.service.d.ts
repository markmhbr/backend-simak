...
export declare class DapodikService {
    ...
    getPesertaDidik(sekolahId: string | null, limit?: number, search?: string, page?: number, rombelName?: string): Promise<{
        total: number;
        data: {
    ...
    getGtk(sekolahId: string | null, limit?: number, search?: string, page?: number, type?: 'guru' | 'tendik'): Promise<{
        total: number;
        data: {
            sekolah_id: string | null;
            created_at: Date;
