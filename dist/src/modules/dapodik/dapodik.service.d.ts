...
export declare class DapodikService {
    ...
    getRombonganBelajar(sekolahId: string | null, type?: string, limit?: number, page?: number, search?: string, tingkat?: string, semesterId?: string): Promise<{
        total: number;
        data: {
            jumlah_siswa: number;
            ptk_id_str: any;
    ...
    getGtkFace(sekolahId: string, id: string): Promise<{
        registered: boolean;
        embedding: any;
    }>;
    getStudentFace(sekolahId: string, id: string): Promise<{
        registered: boolean;
        embedding: any;
    }>;
    identifyFace(sekolahId: string, embedding: number[]): Promise<{
        type: string;
        data: {
            sekolah_id: string | null;
            nama: string;
